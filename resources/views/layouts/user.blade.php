...
<head>
    ...
    <link rel="icon" href="{{asset('https://quomodosoft.com/html/ecoshop/assets/images/logos/top-logo.png')}}">
    ...
    <!--------------- swiper-css ---------------->
    <link rel="stylesheet" href="{{asset('https://quomodosoft.com/html/ecoshop/css/swiper10-bundle.min.css')}}">

    <!--------------- bootstrap-css ---------------->
    <link rel="stylesheet" href="{{asset('https://quomodosoft.com/html/ecoshop/css/bootstrap-5.3.2.min.css')}}">

    <!---------------------- Range Slider ------------------->
    <link rel="stylesheet" href="{{asset('https://quomodosoft.com/html/ecoshop/css/nouislider.min.css')}}">

    <!---------------------- Scroll ------------------->
    <link rel="stylesheet" href="{{asset('https://quomodosoft.com/html/ecoshop/css/aos-3.0.0.css')}}">

    <!--------------- additional-css ---------------->
    <link rel="stylesheet" href="{{asset('https://quomodosoft.com/html/ecoshop/css/style.css')}}">
...
{{--
                    ...
                    <div class="col-lg-8">
                        <div class="wrapper">
                            <div class="wrapper-content" data-aos="fade-up">
                                <h3 class="wrapper-title">Get <span class="inner-title">20%</span> Off Discount
                                    Coupon
                                </h3>
            ...
            <div class="container">
                    ...
                    <div class="row gy-5">
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer-order">
                                <div class="logo">
                                    <img src="{{asset('https://quomodosoft.com/html/ecoshop/assets/images/logos/footer-logo.webp" alt="logo">
                                </div>
                                        ...
                                        <div class="icon">
                                            <span>
                                                <svg width="44" height="45" viewBox="0 0 44 45"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="21.9995" cy="22.9961" r="21.5"
                                                        stroke="#424242">
                                                    </circle>
                ...
                <div class="footer-bottom-section">
                    <div class="footer-social">
                        ...
                        <div class="copyright">
                            <p>©2024 <a href="{{asset('https://quomodosoft.com/" target="_blank"
                                    class="inner-text">Quomodosoft</a> All rights reserved</p>
                        </div>
                    </div>
                    <div class="footer-payment-mode">
                        <a href="#">
                            <img src="{{asset('https://quomodosoft.com/html/ecoshop/assets/images/homepage-one/payment-img.png')}}" alt="img">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <!--------------- jQuery ---------------->
    <script src="{{asset('https://quomodosoft.com/html/ecoshop/assets/js/jquery_3.7.1.min.js')}}"></script>

    <!--------------- bootstrap-js ---------------->
    <script src="{{asset('https://quomodosoft.com/html/ecoshop/assets/js/bootstrap_5.3.2.bundle.min.js')}}"></script>

    <!--------------- Range-Slider-js ---------------->
    <script src="{{asset('https://quomodosoft.com/html/ecoshop/assets/js/nouislider.min.js')}}"></script>

    <!--------------- scroll-Animation-js ---------------->
    <script src="{{asset('https://quomodosoft.com/html/ecoshop/assets/js/aos-3.0.0.js')}}"></script>

    <!--------------- swiper-js ---------------->
    <script src="{{asset('https://quomodosoft.com/html/ecoshop/assets/js/swiper10-bundle.min.js')}}"></script>

    <!--------------- additional-js ---------------->
    <script src="{{asset('https://quomodosoft.com/html/ecoshop/assets/js/ecoshop.js')}}"></script>
